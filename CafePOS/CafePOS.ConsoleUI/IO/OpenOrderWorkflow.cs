...
namespace CafePOS.ConsoleUI.IO
{
    ...
    {
        public static void AddItemsToOrder(IOpenOrderService service)
        {
        ...
        public static void GetAvailableItemsByCategory(IOpenOrderService service, int categoryId)
        {
        ...
        public static bool ListOpenOrders(IOpenOrderService service, bool viewDetails, string title)
        {
        ...
        public static int SelectOpenOrder(IOpenOrderService service)
        {
            do
            {
        ...
        public static int ListandSelectCategory(IOpenOrderService service)
        {
            Console.Clear();
        ...
        public static void ListOrderDetails(IOpenOrderService service, int orderId)
        {
